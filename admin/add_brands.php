...
if(isset($_POST['submit'])){
    ...
    if($msg=='') {
       if(isset($_GET['id']) &&$_GET['id']!='') {
         ...
         mysqli_query($con,"insert into brands(brands,status) value('$brands','1')");
                       ...
                       <form method="post">
                        <div class="card-body card-block">
                           <div class="form-group">
                               ...
                               <input type="text" name="brands" placeholder="Enter Brands name" class="form-control" required value="<?php echo $brands ?>">
                            </div>
