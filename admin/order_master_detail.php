				...
				<div class="card-body--">
				   <div class="table-stats order-table ov-h">
					  <table class="table">
								...
								<tbody>
									<?php
									$res=mysqli_query($con,"select distinct(order_details.id) ,order_details.*,model.name,model.image,`order`.address,`order`.city,`order`.pincode from order_details,model ,`order` where order_details.order_id='$order_id' and  order_details.model_id=model.id GROUP by order_details.id");
									$total_price=0;
