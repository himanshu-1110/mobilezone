...
function sort_model_drop(cat_id,site_path){
	var sort_model_id=jQuery('#sort_model_id').val();
	window.location.href=site_path+"brands.php?id="+cat_id+"&sort="+sort_model_id;
}
